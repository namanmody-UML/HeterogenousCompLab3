...
module k0_ZTS6MMstv2_bb_ZTS6MMstv2_B1 (
    ...
    wire [0:0] ZTS6MMstv2_B1_merge_out_forked105;
    ...
    wire [0:0] bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_stall_out;
    wire [0:0] bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_valid_out;
    ...
    k0_ZTS6MMstv2_ZTS6MMstv2_B1_merge theZTS6MMstv2_B1_merge (
        ...
        .out_forked105(ZTS6MMstv2_B1_merge_out_forked105),
    ...
    k0_ZTS6MMstv2_bb_ZTS6MMstv2_B1_stall_region thebb_ZTS6MMstv2_B1_stall_region (
        .in_arg0(in_arg0),
        .in_forked105(ZTS6MMstv2_B1_merge_out_forked105),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(ZTS6MMstv2_B1_branch_out_stall_out),
        .in_valid_in(ZTS6MMstv2_B1_merge_out_valid_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_stall_out(bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_valid_out(bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,22)
    assign out_exiting_valid_out = bb_ZTS6MMstv2_B1_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going102_k0_zts6mmstv22_exiting_valid_out;
