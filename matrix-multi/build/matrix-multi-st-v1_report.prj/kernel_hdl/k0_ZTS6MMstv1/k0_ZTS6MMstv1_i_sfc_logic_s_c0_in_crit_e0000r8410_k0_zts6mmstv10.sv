...
// SystemVerilog created from k0_ZTS6MMstv1_i_sfc_logic_s_c0_in_crit_e0000r8410_k0_zts6mmstv10
...
module k0_ZTS6MMstv1_i_sfc_logic_s_c0_in_crit_e0000r8410_k0_zts6mmstv10 (
    ...
    // redist27_i_llvm_fpga_pop_i1_notcmp1832_pop24_k0_zts6mmstv162_out_data_out_6(DELAY,406)
    dspba_delay_ver #( .width(1), .depth(6), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    ...
    // redist26_i_llvm_fpga_pop_i1_notcmp2331_pop23_k0_zts6mmstv160_out_data_out_6(DELAY,405)
    dspba_delay_ver #( .width(1), .depth(6), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_notEnable(LOGICAL,479)
    assign redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_notEnable_q = $unsigned(~ (VCC_q));

    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_nor(LOGICAL,480)
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_mem_last(CONSTANT,476)
    assign redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_mem_last_q = $unsigned(2'b01);

    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_cmp(LOGICAL,477)
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_cmpReg(REG,478)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_sticky_ena(REG,481)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_enaAnd(LOGICAL,482)
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_rdcnt(COUNTER,474)
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_wraddr(REG,475)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_mem(DUALMEM,473)
    ...
    // redist24_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_5_outputreg0(DELAY,472)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist25_i_llvm_fpga_pop_i64_acl_078_i286_pop1033_pop25_k0_zts6mmstv128_out_data_out_6(DELAY,404)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
