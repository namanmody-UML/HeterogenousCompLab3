...
module k1_ZTS13MMstv3_cplusd_i_sfc_logic_s_c0_i0001_zts13mmstv3_cplusd0 (
    ...
    // redist9_i_llvm_fpga_pop_i1_notcmp613_pop15_k1_zts13mmstv3_cplusd40_out_data_out_1(DELAY,177)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist11_i_llvm_fpga_pop_i1_exitcond312_pop14_k1_zts13mmstv3_cplusd38_out_data_out_1(DELAY,179)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // redist10_i_llvm_fpga_pop_i1_memdep_phi_pop714_pop16_k1_zts13mmstv3_cplusd23_out_data_out_1(DELAY,178)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
