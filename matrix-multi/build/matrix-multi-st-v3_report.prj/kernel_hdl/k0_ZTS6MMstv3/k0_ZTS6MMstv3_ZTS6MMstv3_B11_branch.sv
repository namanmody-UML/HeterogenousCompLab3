...
module k0_ZTS6MMstv3_ZTS6MMstv3_B11_branch (
    ...
    assign out_c0_exe1079246 = in_c0_exe1079246;

    // out_c0_exe1179348(GPOUT,18)
    assign out_c0_exe1179348 = in_c0_exe1179348;

    // out_c0_exe1379551(GPOUT,19)
    assign out_c0_exe1379551 = in_c0_exe1379551;

    // out_c0_exe1479653(GPOUT,20)
    assign out_c0_exe1479653 = in_c0_exe1479653;

    // out_c0_exe1579755(GPOUT,21)
    assign out_c0_exe1579755 = in_c0_exe1579755;

    // out_c0_exe1679857(GPOUT,22)
    assign out_c0_exe1679857 = in_c0_exe1679857;

    // out_c0_exe278432(GPOUT,23)
    assign out_c0_exe278432 = in_c0_exe278432;

    // out_c0_exe478634(GPOUT,24)
    assign out_c0_exe478634 = in_c0_exe478634;

    // out_c0_exe578736(GPOUT,25)
    assign out_c0_exe578736 = in_c0_exe578736;

    // out_c0_exe678838(GPOUT,26)
    assign out_c0_exe678838 = in_c0_exe678838;

    // out_c0_exe778940(GPOUT,27)
    assign out_c0_exe778940 = in_c0_exe778940;

    // out_c0_exe879042(GPOUT,28)
    assign out_c0_exe879042 = in_c0_exe879042;

    // out_c0_exe979144(GPOUT,29)
    assign out_c0_exe979144 = in_c0_exe979144;
