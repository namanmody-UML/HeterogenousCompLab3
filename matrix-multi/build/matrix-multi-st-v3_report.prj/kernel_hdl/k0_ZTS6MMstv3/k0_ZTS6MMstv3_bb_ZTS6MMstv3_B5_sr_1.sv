...
module k0_ZTS6MMstv3_bb_ZTS6MMstv3_B5_sr_1 (
    ...
    input wire [9:0] in_i_data_5_tpl,
    input wire [9:0] in_i_data_6_tpl,
    input wire [9:0] in_i_data_7_tpl,
    ...
    input wire [9:0] in_i_data_28_tpl,
    input wire [9:0] in_i_data_29_tpl,
    ...
    output wire [9:0] out_o_data_5_tpl,
    output wire [9:0] out_o_data_6_tpl,
    output wire [9:0] out_o_data_7_tpl,
    ...
    output wire [9:0] out_o_data_28_tpl,
    output wire [9:0] out_o_data_29_tpl,
    ...
    reg [9:0] data_mux_5_x_q;
    wire [0:0] data_mux_6_x_s;
    reg [9:0] data_mux_6_x_q;
    wire [0:0] data_mux_7_x_s;
    reg [9:0] data_mux_7_x_q;
    ...
    reg [9:0] data_mux_27_x_q;
    wire [0:0] data_mux_28_x_s;
    reg [9:0] data_mux_28_x_q;
    wire [0:0] data_mux_29_x_s;
    reg [9:0] data_mux_29_x_q;
    ...
    // out_o_stall(GPOUT,77)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,78)
    ...
    begin
        if (!resetn)
        begin
            sr_5_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_5_x_s)
            ...
            default : data_mux_5_x_q = 10'b0;
        endcase
    end

    // out_o_data_5_tpl(GPOUT,84)
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_6_x_s)
            ...
            default : data_mux_6_x_q = 10'b0;
        endcase
    end

    // out_o_data_6_tpl(GPOUT,85)
    ...
    begin
        if (!resetn)
        begin
            sr_7_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_7_x_s)
            ...
            default : data_mux_7_x_q = 10'b0;
        endcase
    end

    // out_o_data_7_tpl(GPOUT,86)
    ...
    begin
        if (!resetn)
        begin
            sr_27_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_27_x_s)
            ...
            default : data_mux_27_x_q = 10'b0;
        endcase
    end

    // out_o_data_27_tpl(GPOUT,106)
    ...
    begin
        if (!resetn)
        begin
            sr_28_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_28_x_s)
            ...
            default : data_mux_28_x_q = 10'b0;
        endcase
    end

    // out_o_data_28_tpl(GPOUT,107)
    ...
    begin
        if (!resetn)
        begin
            sr_29_x_q <= $unsigned(10'b0000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_29_x_s)
            ...
            default : data_mux_29_x_q = 10'b0;
        endcase
    end

    // out_o_data_29_tpl(GPOUT,108)
