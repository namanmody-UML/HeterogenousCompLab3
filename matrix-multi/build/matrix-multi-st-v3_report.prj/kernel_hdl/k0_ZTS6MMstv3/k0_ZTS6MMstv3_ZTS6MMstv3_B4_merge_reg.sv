...
module k0_ZTS6MMstv3_ZTS6MMstv3_B4_merge_reg (
    ...
    reg [9:0] ZTS6MMstv3_B4_merge_reg_data_reg_5_x_q;
    reg [9:0] ZTS6MMstv3_B4_merge_reg_data_reg_6_x_q;
    reg [9:0] ZTS6MMstv3_B4_merge_reg_data_reg_7_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_8_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_9_x_q;
    reg [31:0] ZTS6MMstv3_B4_merge_reg_data_reg_10_x_q;
    ...
    reg [31:0] ZTS6MMstv3_B4_merge_reg_data_reg_14_x_q;
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_14_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_10_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_7_x_q <= $unsigned(10'b0000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_6_x_q <= $unsigned(10'b0000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_5_x_q <= $unsigned(10'b0000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
