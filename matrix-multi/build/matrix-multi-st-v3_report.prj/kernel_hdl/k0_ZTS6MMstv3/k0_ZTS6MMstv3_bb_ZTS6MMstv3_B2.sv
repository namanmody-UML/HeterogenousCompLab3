...
module k0_ZTS6MMstv3_bb_ZTS6MMstv3_B2 (
    ...
    input wire [0:0] in_c0_exe697459_0,
    input wire [0:0] in_c0_exe797562_0,
    input wire [0:0] in_memdep_72_0,
    ...
    wire [0:0] ZTS6MMstv3_B2_branch_out_valid_out_1;
    wire [0:0] ZTS6MMstv3_B2_merge_out_c0_exe697459;
    wire [0:0] ZTS6MMstv3_B2_merge_out_c0_exe797562;
    wire [0:0] ZTS6MMstv3_B2_merge_out_memdep_72;
    wire [0:0] ZTS6MMstv3_B2_merge_out_stall_out_0;
    wire [0:0] ZTS6MMstv3_B2_merge_out_valid_out;
    wire [0:0] bb_ZTS6MMstv3_B2_stall_region_out_c0_exe797562;
    wire [0:0] bb_ZTS6MMstv3_B2_stall_region_out_feedback_out_22;
    wire [0:0] bb_ZTS6MMstv3_B2_stall_region_out_feedback_valid_out_22;
    ...
    k0_ZTS6MMstv3_ZTS6MMstv3_B2_branch theZTS6MMstv3_B2_branch (
        .in_c0_exe797562(bb_ZTS6MMstv3_B2_stall_region_out_c0_exe797562),
        ...
        .out_valid_out_1(ZTS6MMstv3_B2_branch_out_valid_out_1),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    k0_ZTS6MMstv3_ZTS6MMstv3_B2_merge theZTS6MMstv3_B2_merge (
        .in_c0_exe697459_0(in_c0_exe697459_0),
        .in_c0_exe797562_0(in_c0_exe797562_0),
        .in_memdep_72_0(in_memdep_72_0),
        .in_stall_in(bb_ZTS6MMstv3_B2_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe697459(ZTS6MMstv3_B2_merge_out_c0_exe697459),
        .out_c0_exe797562(ZTS6MMstv3_B2_merge_out_c0_exe797562),
        .out_memdep_72(ZTS6MMstv3_B2_merge_out_memdep_72),
    ...
    k0_ZTS6MMstv3_bb_ZTS6MMstv3_B2_stall_region thebb_ZTS6MMstv3_B2_stall_region (
        .in_c0_exe697459(ZTS6MMstv3_B2_merge_out_c0_exe697459),
        .in_c0_exe797562(ZTS6MMstv3_B2_merge_out_c0_exe797562),
        .in_feedback_stall_in_22(in_feedback_stall_in_22),
        .in_memdep_72(ZTS6MMstv3_B2_merge_out_memdep_72),
        .in_stall_in(ZTS6MMstv3_B2_branch_out_stall_out),
        .in_valid_in(ZTS6MMstv3_B2_merge_out_valid_out),
        .out_c0_exe797562(bb_ZTS6MMstv3_B2_stall_region_out_c0_exe797562),
        .out_feedback_out_22(bb_ZTS6MMstv3_B2_stall_region_out_feedback_out_22),
        .out_feedback_valid_out_22(bb_ZTS6MMstv3_B2_stall_region_out_feedback_valid_out_22),
    ...
    assign out_feedback_out_22 = bb_ZTS6MMstv3_B2_stall_region_out_feedback_out_22;

    // feedback_valid_out_22_sync(GPOUT,7)
    assign out_feedback_valid_out_22 = bb_ZTS6MMstv3_B2_stall_region_out_feedback_valid_out_22;
    ...
    assign out_valid_out_1 = ZTS6MMstv3_B2_branch_out_valid_out_1;
